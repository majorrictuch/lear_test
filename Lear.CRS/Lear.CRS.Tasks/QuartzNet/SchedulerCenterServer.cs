...
using Lear.CRS.Tasks.QuartzNet;
...
namespace Lear.CRS.Tasks
{
    ...
    public class SchedulerCenterServer : ISchedulerCenter
    {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<ApiResult<string>> StartScheduleAsync()
        {
            ...
            try
            {
                ...
                if (!this._scheduler.Result.IsStarted)
                {
                    ...
                    this._scheduler.Result.ListenerManager.AddSchedulerListener(new CustomSchedulerListener());
                    this._scheduler.Result.ListenerManager.AddJobListener(new CustomJobListener());
                    this._scheduler.Result.ListenerManager.AddTriggerListener(new CustomTriggerListener());
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<ApiResult<string>> StopScheduleAsync()
        {
            var result = new ApiResult<string>();
            try
            {
        ...
        /// <returns></returns>
        public async Task<ApiResult<string>> AddScheduleJobAsync(TasksQz tasksQz)
        {
            var result = new ApiResult<string>();
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<ApiResult<string>> StopScheduleJobAsync(TasksQz sysSchedule)
        {
            var result = new ApiResult<string>();
            try
            {
        ...
        /// <returns></returns>
        public async Task<ApiResult<string>> ResumeJob(TasksQz sysSchedule)
        {
            var result = new ApiResult<string>();
            try
            {
        ...
        /// <param name="sysSchedule"></param>
        /// <returns></returns>
        public async Task<ApiResult<string>> PauseJob(TasksQz sysSchedule)
        {
            var result = new ApiResult<string>();
            try
            {
        ...
        private ITrigger CreateSimpleTrigger(TasksQz sysSchedule)
        {
            if (sysSchedule.CycleRunTimes > 0)
            {
                ...
                .WithSimpleSchedule(x => x
                    .WithIntervalInSeconds(sysSchedule.IntervalSecond??0)
                    .WithRepeatCount(sysSchedule.CycleRunTimes??0 - 1))
        ...
        /// <param name="tasksQz"></param>
        /// <returns></returns>
        public async Task<ApiResult<string>> ExecuteJobAsync(TasksQz tasksQz)
        {
            var result = new ApiResult<string>();
            try
            {
