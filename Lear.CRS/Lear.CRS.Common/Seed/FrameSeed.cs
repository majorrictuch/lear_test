...
namespace Lear.CRS.Common.Seed
{
    public class FrameSeed
    {
        ...
        {
            Create_Controller_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Qt.Core.Api.Controllers", "Qt.Core.Api.Controllers", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_Model_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Qt.Core.Model", "Qt.Core.Model.Models", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_IRepository_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Qt.Core.IRepository", "Qt.Core.IRepository", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_IServices_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Qt.Core.IServices", "Qt.Core.IServices", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_Repository_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Qt.Core.Repository", "Qt.Core.Repository", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_Services_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Qt.Core.Services", "Qt.Core.Services", tableNames, "", isMuti);
            return true;
        }
...
@"using Qt.Core.IServices;
using Qt.Core.Model;
using Qt.Core.Model.Models;
...
namespace " + strNameSpace + @"
{
     ...
     public class {ClassName}Controller :BaseController
    {
            ...
            [HttpGet]
            public async Task<ApiResult<PageModel<{ClassName}>>> Get(int page = 1, string key = """",int intPageSize = 50)
            {
                ...
                return new ApiResult<PageModel<{ClassName}>>()
                {
                    msg = ""获取成功"",
                    success = true,
            ...
            [HttpGet(""{id}"")]
            public async Task<ApiResult<{ClassName}>> Get(string id)
            {
                return new ApiResult<{ClassName}>()
                {
                    msg = ""获取成功"",
                    success = true,
            ...
            [HttpPost]
            public async Task<ApiResult<string>> Post([FromBody] {ClassName} request)
            {
            ...
            [HttpPut]
            public async Task<ApiResult<string>> Put([FromBody] {ClassName} request)
            {
                var data = new ApiResult<string>();
...
@"{SugarColumn}
            ...
            )
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                 ...
                 .SettingClassTemplate(p => p =
@"using Qt.Core.IRepository.Base;
using Qt.Core.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
    ...
    public interface I{ClassName}Services :IBaseServices<{ClassName}>" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
	{
          ...
          bool isMuti = false)
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
@"using Qt.Core.IRepository" + (isMuti ? "." + ConnId + "" : "") + @";
using Qt.Core.IRepository.UnitOfWork;
using Qt.Core.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
using Qt.Core.Repository.Base;
    ...
    public class {ClassName}Repository : BaseRepository<{ClassName}>, I{ClassName}Repository" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
    {
          ...
          bool isMuti = false)
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
@"
using Qt.Core.IServices" + (isMuti ? "." + ConnId + "" : "") + @";
using Qt.Core.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
using Qt.Core.Services.BASE;
using Qt.Core.IRepository.Base;
